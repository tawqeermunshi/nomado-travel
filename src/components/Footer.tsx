    ...
    <footer id="reach-us" className="bg-[#083A7A] border-t border-[#0F4C9C]/50 px-6 md:px-12 lg:px-20 py-20 scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            <div className="mb-5">
              <span className="text-[1.3rem] tracking-wide"><span className="font-century-bold text-[#F59E0B]">nomado</span><span className="font-century text-[#F5F9FD]">.travel</span></span>
            </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="tel:+919858716229" className="font-clash text-[12px] tracking-[0.1em] text-[#B6C6DD] hover:text-white transition-colors duration-300">
              +91 9858716229
            </a>
